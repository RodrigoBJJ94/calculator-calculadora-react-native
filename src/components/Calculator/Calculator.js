...
import DisplayDark from '../DisplayDark/DisplayDark';
import DisplayLight from '../DisplayLight/DisplayLight';
...
export default function Calculator({ color }) {
  ...
  return (
    <View style={Styles.container}>
      {color ? <DisplayDark value={valueScreen} result={valueResult} /> : <DisplayLight value={valueScreen} result={valueResult} />}
